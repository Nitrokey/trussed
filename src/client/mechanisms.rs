...
impl<B: 'static, S: Syscall> Aes256Cbc for ClientImplementation<'_, B, S> {}
...
impl<B: 'static, S: Syscall> Chacha8Poly1305 for ClientImplementation<'_, B, S> {}
...
impl<B: 'static, S: Syscall> HmacSha1 for ClientImplementation<'_, B, S> {}
...
impl<B: 'static, S: Syscall> HmacSha256 for ClientImplementation<'_, B, S> {}
...
impl<B: 'static, S: Syscall> HmacSha512 for ClientImplementation<'_, B, S> {}
...
#[cfg(feature = "ed255")]
impl<B: 'static, S: Syscall> Ed255 for ClientImplementation<'_, B, S> {}
...
#[cfg(feature = "p256")]
impl<B: 'static, S: Syscall> P256 for ClientImplementation<'_, B, S> {}
...
#[cfg(feature = "sha256")]
impl<B: 'static, S: Syscall> Sha256 for ClientImplementation<'_, B, S> {}
...
#[cfg(feature = "tdes")]
impl<B: 'static, S: Syscall> Tdes for ClientImplementation<'_, B, S> {}
...
#[cfg(feature = "totp")]
impl<B: 'static, S: Syscall> Totp for ClientImplementation<'_, B, S> {}
...
#[cfg(feature = "x255")]
impl<B: 'static, S: Syscall> X255 for ClientImplementation<'_, B, S> {}
